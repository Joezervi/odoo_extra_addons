# -*- coding: utf-8 -*-
{
	...
	''',
	'author': 'BROWSEINFO',
	'website': 'https://www.browseinfo.com/demo-request?app=bi_import_chart_of_accounts&version=19&edition=Community',
	...
	'auto_install': False,
	'installable': True,
	'live_test_url'	:'https://www.browseinfo.com/demo-request?app=bi_import_chart_of_accounts&version=19&edition=Community',
    	'application': True,
    	'qweb': [
    		],
